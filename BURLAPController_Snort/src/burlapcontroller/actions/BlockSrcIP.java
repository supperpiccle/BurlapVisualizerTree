 ...
 * @author stefano
 */
public class BlockSrcIP extends CriteriaAction implements FullActionModel {

    public BlockSrcIP(String actionName, Domain domain) throws IOException {
    ...
    protected State performActionHelper(State s, GroundedAction groundedAction) {
        ...
        agent.setValue(ATTBLOCKEDIPS, sBlockedIps + sAttackerIp + ";");
...
//        super.printDebugInfo(s.getFirstObjectOfClass(CLASSAGENT));
        ...
        ns1.getFirstObjectOfClass(CLASSAGENT).setValue(ATTBLOCKEDIPS, sBlockedIps + sAttackerIp + ";");
