...
import static burlapcontroller.Controller.ATTREBOOTED;
 ...
 * @author stefano
 */
public class QuarantineSystem extends CriteriaAction implements FullActionModel {



    public QuarantineSystem(String actionName, Domain domain) throws IOException {
    ...
    protected State performActionHelper(State s, GroundedAction groundedAction) {
        ...
        agent.setValue(ATTQUARANTINED, true);
...
//        super.printDebugInfo(s.getFirstObjectOfClass(CLASSAGENT));
        ...
        ns1.getFirstObjectOfClass(CLASSAGENT).setValue(ATTQUARANTINED, true);
