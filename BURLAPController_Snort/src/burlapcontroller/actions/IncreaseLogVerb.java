 ...
 * @author stefano
 */
public class IncreaseLogVerb extends CriteriaAction implements FullActionModel {

    public IncreaseLogVerb(String actionName, Domain domain) throws IOException {
