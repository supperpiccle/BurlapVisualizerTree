 ...
 * @author stefano
 */
public class GenerateAlert extends CriteriaAction implements FullActionModel {

    public GenerateAlert(String actionName, Domain domain) throws IOException {
    ...
    protected State performActionHelper(State s, GroundedAction groundedAction) {
        ...
        agent.setValue(ATTALERTED, true);
...
//        super.printDebugInfo(s.getFirstObjectOfClass(CLASSAGENT));
        ...
        ns1.getFirstObjectOfClass(CLASSAGENT).setValue(ATTALERTED, true);
