...
import static burlapcontroller.Controller.ATTBLOCKEDIPS;
 ...
 * @author stefano
 */
public class UnblockSrcIP extends CriteriaAction implements FullActionModel {

    public UnblockSrcIP(String actionName, Domain domain) throws IOException {
...
//        super.printDebugInfo(s.getFirstObjectOfClass(CLASSAGENT));
        ...
        ns1.getFirstObjectOfClass(CLASSAGENT).setValue(ATTBLOCKEDIPS, "");
