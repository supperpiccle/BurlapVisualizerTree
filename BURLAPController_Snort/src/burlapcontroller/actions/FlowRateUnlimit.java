...
import static burlapcontroller.Controller.ATTFLOWLIMITIPS;
 ...
 * @author stefano
 */
public class FlowRateUnlimit extends CriteriaAction implements FullActionModel {

    public FlowRateUnlimit(String actionName, Domain domain) throws IOException {
...
//        super.printDebugInfo(s.getFirstObjectOfClass(CLASSAGENT));
        ...
        ns1.getFirstObjectOfClass(CLASSAGENT).setValue(ATTFLOWLIMITIPS, "");
