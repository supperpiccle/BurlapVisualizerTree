 ...
 * @author stefano
 */
public class DisableHoneypot extends CriteriaAction implements FullActionModel {

    public DisableHoneypot(String actionName, Domain domain) throws IOException {
...
//        super.printDebugInfo(s.getFirstObjectOfClass(CLASSAGENT));
        ...
        ns1.getFirstObjectOfClass(CLASSAGENT).setValue(ATTHONEYPOTIPS, "");
